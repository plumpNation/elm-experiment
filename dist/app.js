...
var _plumpNation$elm_experiment$Models$initialModel = function (route) {
	return {players: _krisajenkins$remotedata$RemoteData$Loading, originalPlayers: _krisajenkins$remotedata$RemoteData$Loading, route: route};
};
var _plumpNation$elm_experiment$Models$Model = F3(
	function (a, b, c) {
		return {players: a, originalPlayers: b, route: c};
	});
var _plumpNation$elm_experiment$Models$Player = F3(
	function (a, b, c) {
		return {id: a, name: b, level: c};
	});
var _plumpNation$elm_experiment$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _plumpNation$elm_experiment$Models$PlayerRoute = function (a) {
	return {ctor: 'PlayerRoute', _0: a};
};
var _plumpNation$elm_experiment$Models$PlayersRoute = {ctor: 'PlayersRoute'};

var _plumpNation$elm_experiment$Msgs$FilterPlayers = function (a) {
	return {ctor: 'FilterPlayers', _0: a};
};
var _plumpNation$elm_experiment$Msgs$OnPlayerSave = function (a) {
	return {ctor: 'OnPlayerSave', _0: a};
};
var _plumpNation$elm_experiment$Msgs$ChangeLevel = F2(
	function (a, b) {
		return {ctor: 'ChangeLevel', _0: a, _1: b};
	});
var _plumpNation$elm_experiment$Msgs$OnLocationChange = function (a) {
	return {ctor: 'OnLocationChange', _0: a};
};
var _plumpNation$elm_experiment$Msgs$OnFetchPlayers = function (a) {
	return {ctor: 'OnFetchPlayers', _0: a};
};

var _plumpNation$elm_experiment$Commands$playerEncoder = function (player) {
	var attributes = {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _plumpNation$elm_experiment$Commands$savePlayerUrl = function (playerId) {
	return A2(_elm_lang$core$Basics_ops['++'], 'http://localhost:4000/players/', playerId);
};
var _plumpNation$elm_experiment$Commands$playerDecoder = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_plumpNation$elm_experiment$Models$Player))));
var _plumpNation$elm_experiment$Commands$savePlayerRequest = function (player) {
	return _elm_lang$http$Http$request(
		{
			body: _elm_lang$http$Http$jsonBody(
				_plumpNation$elm_experiment$Commands$playerEncoder(player)),
			expect: _elm_lang$http$Http$expectJson(_plumpNation$elm_experiment$Commands$playerDecoder),
			headers: {ctor: '[]'},
			method: 'PATCH',
			timeout: _elm_lang$core$Maybe$Nothing,
			url: _plumpNation$elm_experiment$Commands$savePlayerUrl(player.id),
			withCredentials: false
		});
};
var _plumpNation$elm_experiment$Commands$savePlayerCmd = function (player) {
	return A2(
		_elm_lang$http$Http$send,
		_plumpNation$elm_experiment$Msgs$OnPlayerSave,
		_plumpNation$elm_experiment$Commands$savePlayerRequest(player));
};
var _plumpNation$elm_experiment$Commands$playersDecoder = _elm_lang$core$Json_Decode$list(_plumpNation$elm_experiment$Commands$playerDecoder);
var _plumpNation$elm_experiment$Commands$fetchPlayersUrl = 'http://localhost:4000/players';
var _plumpNation$elm_experiment$Commands$fetchPlayers = A2(
	_elm_lang$core$Platform_Cmd$map,
	_plumpNation$elm_experiment$Msgs$OnFetchPlayers,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(_elm_lang$http$Http$get, _plumpNation$elm_experiment$Commands$fetchPlayersUrl, _plumpNation$elm_experiment$Commands$playersDecoder)));

var _plumpNation$elm_experiment$Routing$playerPath = function (id) {
	return A2(_elm_lang$core$Basics_ops['++'], '#players/', id);
};
var _plumpNation$elm_experiment$Routing$playersPath = '#players';
var _plumpNation$elm_experiment$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _plumpNation$elm_experiment$Models$PlayersRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_plumpNation$elm_experiment$Models$PlayerRoute,
				A2(
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_plumpNation$elm_experiment$Models$PlayersRoute,
					_evancz$url_parser$UrlParser$s('players')),
				_1: {ctor: '[]'}
			}
		}
	});
var _plumpNation$elm_experiment$Routing$parseLocation = function (location) {
	var _p0 = A2(_evancz$url_parser$UrlParser$parseHash, _plumpNation$elm_experiment$Routing$matchers, location);
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
		return _plumpNation$elm_experiment$Models$NotFoundRoute;
	}
};

var _plumpNation$elm_experiment$Update$updatePlayer = F2(
...
var _plumpNation$elm_experiment$Update$filterPlayers = F2(
	function (model, query) {
		var boom = A2(_elm_lang$core$Debug$log, 'query', query);
		var matchesQuery = function (player) {
			return A2(
				_elm_lang$core$String$contains,
				query,
				_elm_lang$core$String$toLower(player.name));
		};
		var filterPlayerList = function (players) {
			return A2(_elm_lang$core$List$filter, matchesQuery, players);
		};
		var filteredPlayers = A2(_krisajenkins$remotedata$RemoteData$map, filterPlayerList, model.originalPlayers);
		return _elm_lang$core$Native_Utils.update(
			model,
			{players: filteredPlayers});
	});
var _plumpNation$elm_experiment$Update$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FilterPlayers':
				return {
					ctor: '_Tuple2',
					_0: A2(_plumpNation$elm_experiment$Update$filterPlayers, model, _p0._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'OnFetchPlayers':
				var _p1 = _p0._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{players: _p1, originalPlayers: _p1}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'OnLocationChange':
				var newRoute = _plumpNation$elm_experiment$Routing$parseLocation(_p0._0);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
			...
			case 'ChangeLevel':
				...
				var updatedPlayer = _elm_lang$core$Native_Utils.update(
					_p2,
					{level: _p2.level + _p0._1});
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _plumpNation$elm_experiment$Commands$savePlayerCmd(updatedPlayer)
				};
			default:
				if (_p0._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: A2(_plumpNation$elm_experiment$Update$updatePlayer, model, _p0._0._0),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
...
var _plumpNation$elm_experiment$Update$toList = function (remoteData) {
	return A2(
		_elm_lang$core$List$map,
		function (item) {
			return item;
...
var _plumpNation$elm_experiment$Players_Edit$listBtn = A2(
	_elm_lang$html$Html$a,
	{
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(_plumpNation$elm_experiment$Routing$playersPath),
			_1: {ctor: '[]'}
		}
	},
	{
...
var _plumpNation$elm_experiment$Players_Edit$btnLevelIncrease = function (player) {
	var message = A2(_plumpNation$elm_experiment$Msgs$ChangeLevel, player, 1);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _plumpNation$elm_experiment$Players_Edit$btnLevelDecrease = function (player) {
	var message = A2(_plumpNation$elm_experiment$Msgs$ChangeLevel, player, -1);
	return A2(
		_elm_lang$html$Html$a,
		{
...
var _plumpNation$elm_experiment$Players_Edit$formLevel = function (player) {
	return A2(
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						...
						_1: {
							ctor: '::',
							_0: _plumpNation$elm_experiment$Players_Edit$btnLevelDecrease(player),
							_1: {
								ctor: '::',
								_0: _plumpNation$elm_experiment$Players_Edit$btnLevelIncrease(player),
								_1: {ctor: '[]'}
							}
						}
					}),
...
var _plumpNation$elm_experiment$Players_Edit$form = function (player) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: _plumpNation$elm_experiment$Players_Edit$formLevel(player),
				_1: {ctor: '[]'}
			}
		});
};
var _plumpNation$elm_experiment$Players_Edit$nav = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _plumpNation$elm_experiment$Players_Edit$listBtn,
			_1: {ctor: '[]'}
		});
};
var _plumpNation$elm_experiment$Players_Edit$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _plumpNation$elm_experiment$Players_Edit$nav(model),
			_1: {
				ctor: '::',
				_0: _plumpNation$elm_experiment$Players_Edit$form(model),
				_1: {ctor: '[]'}
			}
		});
};

var _plumpNation$elm_experiment$Players_List$editBtn = function (player) {
	var path = _plumpNation$elm_experiment$Routing$playerPath(player.id);
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
...
var _plumpNation$elm_experiment$Players_List$playerRow = function (player) {
	return A2(
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _plumpNation$elm_experiment$Players_List$editBtn(player),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _plumpNation$elm_experiment$Players_List$list = function (players) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				{ctor: '[]'},
				{
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _plumpNation$elm_experiment$Players_List$playerRow, players)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _plumpNation$elm_experiment$Players_List$nav = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
...
var _plumpNation$elm_experiment$Players_List$filter = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('filter-container'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_plumpNation$elm_experiment$Msgs$FilterPlayers),
						_1: {ctor: '[]'}
					}
				}
			},
...
var _plumpNation$elm_experiment$Players_List$maybeList = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _plumpNation$elm_experiment$Players_List$list(_p0._0);
		default:
			return _elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(_p0._0));
	}
};
var _plumpNation$elm_experiment$Players_List$view = function (players) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _plumpNation$elm_experiment$Players_List$nav,
			_1: {
				ctor: '::',
				_0: _plumpNation$elm_experiment$Players_List$filter,
				_1: {
					ctor: '::',
					_0: _plumpNation$elm_experiment$Players_List$maybeList(players),
					_1: {ctor: '[]'}
				}
			}
		});
...
var _plumpNation$elm_experiment$View$notFoundView = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _plumpNation$elm_experiment$View$playerEditPage = F2(
	function (model, playerId) {
		...
		switch (_p0.ctor) {
			...
			case 'Success':
				...
				var _p1 = maybePlayer;
				if (_p1.ctor === 'Just') {
					return _plumpNation$elm_experiment$Players_Edit$view(_p1._0);
				} else {
					return _plumpNation$elm_experiment$View$notFoundView;
				}
			default:
				return _elm_lang$html$Html$text(
					_elm_lang$core$Basics$toString(_p0._0));
...
var _plumpNation$elm_experiment$View$page = function (model) {
	var _p2 = model.route;
	switch (_p2.ctor) {
		case 'PlayersRoute':
			return _plumpNation$elm_experiment$Players_List$view(model.players);
		case 'PlayerRoute':
			return A2(_plumpNation$elm_experiment$View$playerEditPage, model, _p2._0);
		default:
			return _plumpNation$elm_experiment$View$notFoundView;
	}
};
var _plumpNation$elm_experiment$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _plumpNation$elm_experiment$View$page(model),
			_1: {ctor: '[]'}
		});
};

var _plumpNation$elm_experiment$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _plumpNation$elm_experiment$Main$init = function (location) {
	var currentRoute = _plumpNation$elm_experiment$Routing$parseLocation(location);
	return {
		ctor: '_Tuple2',
		_0: _plumpNation$elm_experiment$Models$initialModel(currentRoute),
		_1: _plumpNation$elm_experiment$Commands$fetchPlayers
	};
};
var _plumpNation$elm_experiment$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_plumpNation$elm_experiment$Msgs$OnLocationChange,
	{init: _plumpNation$elm_experiment$Main$init, view: _plumpNation$elm_experiment$View$view, update: _plumpNation$elm_experiment$Update$update, subscriptions: _plumpNation$elm_experiment$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _plumpNation$elm_experiment$Main$main !== 'undefined') {
    _plumpNation$elm_experiment$Main$main(Elm['Main'], 'Main', undefined);
}
